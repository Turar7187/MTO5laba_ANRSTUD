...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker3 = new LatLng(51.727845, 75.321685);
    static final LatLng marker4 = new LatLng(51.727553, 75.329385);
    static final LatLng marker5 = new LatLng(51.728832, 75.324633);
    static final LatLng marker6 = new LatLng(51.715216, 75.332637);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.bol)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.kz)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.max)).alpha(ALPHA).
